...
# def read_item(request: Request, db: Session = Depends(get_db), book: str = ""):
#     book = crud.get_item(db, item_id=book) 
...
# @book_router.get("/{book_id}/loan", response_class=HTMLResponse)
# def loan_item(request: Request, db: Session = Depends(get_db), book_id: str= ""):
#     book = crud.get_item(db, item_id=book_id)
#     book_authors = crud.get_authors_by_item(db, item_id=book_id)[0].author_id
#     author = crud.get_item_by_author(db, author_id=book_authors)
#     context = {
...
# def read_item(db: Session = Depends(get_db), book_id: str= ""):
#     book = crud.get_item(db, item_id=book_id)
#     book_authors = crud.get_authors_by_item(db, item_id=book_id)[0].author_id
#     author = crud.get_item_by_author(db, author_id=book_authors)
#     context = {
