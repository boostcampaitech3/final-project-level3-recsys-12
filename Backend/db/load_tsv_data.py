...
def make_books_meta_df(
    ...
    book_autor_path: str,
    book_genre_path: str,
    book_path: str,) -> List[pd.DataFrame]:
    ...
    return [user_df, author_df, genre_df, book_df, book_autor_df, book_genre_df]
...
if __name__ == '__main__':
    ...
    table_names = ['users', 'authors', 'genres', 'books', 'book_authors', 'book_genres'] 
